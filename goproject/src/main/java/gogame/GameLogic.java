...
public class GameLogic implements Logic {
    ...
    public int ifbot=1,pas=0,bot=0,white_score=0,randomNum,xbot,ybot,black_score=0,size=9,breath_count=0,breath_count1=-1,breath_count2=-1,breath_count3=-1,breath_count4=-1;
